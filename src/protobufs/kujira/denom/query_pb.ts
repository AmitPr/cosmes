 ...
 */
export class QueryNoFeeAccountsRequest extends Message<QueryNoFeeAccountsRequest> {
 ...
 */
export class QueryNoFeeAccountsResponse extends Message<QueryNoFeeAccountsResponse> {
  /**
