...
import { isAndroid } from "../utils/os.js";
import { QRCodeModal, shouldDeepLink } from "./QRCodeModal.js";
const Method = {
...
export class WalletConnectV2 {
    ...
    async connect(chainIds, clearRequired) {
        ...
        const optionalNamespaces = clearRequired ? {
            cosmos: {
    ...
    async getAccount(chainId) {
        const response = await this.request(chainId, Method.GET_ACCOUNTS, {});
    ...
    async request(chainId, method, params) {
        ...
        if (shouldDeepLink(this.mobileAppDetails) &&
