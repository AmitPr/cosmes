import { Tx, calculateFee, getAccount, pollTx, simulateTx, toBaseAccount, } from "cosmes/client";
...
export class ConnectedWallet {
    constructor(id, type, chainId, pubKey, address, gasPrice) {
        this.id = id;
        this.type = type;
     ...
     */
    async getAuthInfo(rpc, fromCache = false) {
     ...
     */
    async estimateFee(rpc, { msgs, memo }, feeMultiplier = 1.4) {
     ...
     */
    async broadcastTx(rpc, unsignedTx, fee) {
     ...
     */
    async pollTx(rpc, txHash, { maxAttempts, intervalSeconds } = {}) {
        return pollTx(rpc, {
            hash: txHash,
            maxAttempts,
            intervalSeconds,
     ...
     */
    async broadcastTxSync(rpc, unsignedTx, feeOrFeeMultiplier = 1.4, pollOpts = {}) {
