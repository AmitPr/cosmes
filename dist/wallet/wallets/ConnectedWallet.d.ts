...
import { Adapter, PollTxParams, RpcClient, Secp256k1PubKey } from "../../client/index.js";
...
export declare abstract class ConnectedWallet {
     ...
     */
    protected abstract signAndBroadcastTx(rpc: RpcClient, unsignedTx: UnsignedTx, fee: Fee, accountNumber: bigint, sequence: bigint): Promise<string>;
}
