...
(function (StorageType) {
     ...
     */
    StorageType[StorageType["DEFAULT_UNSPECIFIED"] = 0] = "DEFAULT_UNSPECIFIED";
    /**
     ...
     */
    StorageType[StorageType["TRANSIENT"] = 2] = "TRANSIENT";
    /**
     ...
     */
    StorageType[StorageType["INDEX"] = 3] = "INDEX";
    /**
     ...
     */
    StorageType[StorageType["COMMITMENT"] = 4] = "COMMITMENT";
...
ModuleSchemaDescriptor.runtime = proto3;
ModuleSchemaDescriptor.typeName = "cosmos.orm.v1alpha1.ModuleSchemaDescriptor";
ModuleSchemaDescriptor.fields = proto3.util.newFieldList(() => [
...
export class ModuleSchemaDescriptor_FileEntry extends Message {
    constructor(data) {
         ...
         */
        this.storageType = StorageType.DEFAULT_UNSPECIFIED;
        proto3.util.initPartial(data, this);
    }
    static fromBinary(bytes, options) {
...
ModuleSchemaDescriptor_FileEntry.runtime = proto3;
ModuleSchemaDescriptor_FileEntry.typeName = "cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry";
ModuleSchemaDescriptor_FileEntry.fields = proto3.util.newFieldList(() => [
