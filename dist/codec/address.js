 ...
 */
export function resolveBech32Address(publicKey, prefix, type = "secp256k1") {
    const pubKey = typeof publicKey === "string" ? base64.decode(publicKey) : publicKey;
    const address = type === "secp256k1"
 ...
 */
export function translateEthToBech32Address(ethAddress, prefix) {
