...
const DATA = utf8.decode("Hi from CosmeES! This is a test message just to prove that the wallet is working.");
...
describe("verifyECDSA", () => {
    it("should verify correctly", () => {
        ...
        const signature = base64.decode("Od87qNoOyXuDOVdLCGTXB6dFN7U0XF9Oegc8KDa+AWwX3jkrDXG++2nlPfsF4VJzlDHsoikPeZpxrB7v9PINnw==");
...
describe("verifyADR36", () => {
    it("should verify correctly", () => {
        ...
        const signature = base64.decode("nvlcV0x0Ge8ADXLSAQGtfMw6EJkOfpmkDxgP7UI79uR8MhnAOp9T+e+ofgW9kY4bEIr0yhyBG+vSVAZRv9uCxA==");
    ...
    it("should verify ethsecp256k1 type signatures correctly", () => {
        ...
        const signature = base64.decode("+7PNZm4XxKtpvZA+HqxpMKJgZcqA2w3WVSheLGvzrrIBJZGOTdcpBT7wLUhluY46EokTeRRWUaBDSv2vVoEdfw==");
        const res1 = verifyADR36({
            bech32Prefix: "inj",
...
describe("verifyEIP191", () => {
    it("should verify correctly", () => {
        ...
        const signature = base64.decode("MpriWY0Kq7C+/jR3eOfNB5vUQM144tQk7KkzKyYCTFB5QHGLZjzJyeOSr8/ENFES0k+aaEF47Wepk7OHoZuLzxs=");
