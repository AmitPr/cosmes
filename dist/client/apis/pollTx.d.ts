 ...
 * of `maxAttempts`.
 */
export declare function pollTx(rpc: RpcClient, { intervalSeconds, maxAttempts, ...getTxParams }: PollTxParams): Promise<Required<import("../../protobufs").CosmosTxV1beta1GetTxResponse>>;
